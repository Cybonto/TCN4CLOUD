...
automl_run_id = 'AutoML_3a429dfe-23dc-4da2-aff0-80c99493ecea_1'
...
def generate_data_transformation_config():
    ...
    transformer5 = RestoreDtypesTransformer(
        dtypes={'func_ID': dtype('int64'), '_automl_target_col': dtype('int64'), 'runtime': dtype('O')},
...
def generate_algorithm_config():
    ...
    '''
    from azureml.training.tabular.models._timeseries._auto_arima import AutoArima
    from numpy import array
    
    algorithm = AutoArima(
        timeseries_param_dict={'time_column_name': 'idx', 'grain_column_names': None, 'target_column_name': '__time__', 'drop_column_names': [], 'overwrite_columns': True, 'dropna': False, 'transform_dictionary': {'min': '_automl_target_col', 'max': '_automl_target_col', 'mean': '_automl_target_col'}, 'max_horizon': 300, 'origin_time_colname': 'origin', 'country_or_region': None, 'n_cross_validations': 5, 'short_series_handling': True, 'max_cores_per_iteration': -1, 'feature_lags': None, 'target_aggregation_function': None, 'cv_step_size': 800, 'iteration_timeout_minutes': 1440, 'seasonality': 1, 'use_stl': None, 'freq': 'N', 'short_series_handling_configuration': 'auto', 'target_lags': [0], 'target_rolling_window_size': 0, 'arimax_raw_columns': ['func_ID', 'idx', 'runtime']}
    )
...
def build_model_pipeline():
    ...
    forecast_pipeline_wrapper = ForecastingPipelineWrapper(pipeline, stddev=[19.852119964617483])
