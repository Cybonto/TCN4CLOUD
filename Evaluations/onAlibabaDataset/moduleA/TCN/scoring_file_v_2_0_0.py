...
data_sample = PandasParameterType(pd.DataFrame({"idx": pd.Series(["2000-1-1"], dtype="datetime64[ns]"), "__time__": pd.Series([0], dtype="int64"), "latency": pd.Series([0.0], dtype="float64"), "runtime": pd.Series(["example_value"], dtype="object")}), enforce_shape=False)
