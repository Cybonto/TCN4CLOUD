...
data_sample = PandasParameterType(pd.DataFrame({"idx": pd.Series([0], dtype="int64"), "__time__": pd.Series([0], dtype="int64"), "latency": pd.Series([0.0], dtype="float64"), "runtime": pd.Series(["example_value"], dtype="object")}), enforce_shape=False)
