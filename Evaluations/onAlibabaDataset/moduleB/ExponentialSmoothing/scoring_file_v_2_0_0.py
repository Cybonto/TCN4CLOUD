...
data_sample = PandasParameterType(pd.DataFrame({"idx": pd.Series([0], dtype="int64"), "runtime": pd.Series(["example_value"], dtype="object"), "func_ID": pd.Series([0], dtype="int64")}), enforce_shape=False)
