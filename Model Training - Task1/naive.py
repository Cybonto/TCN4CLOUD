...
iteration = "500"  # PLACEHOLDER
run_id = "AutoML_1f0f9f09-db2b-46b5-a243-253e0d538645_500"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':True,'enable_stack_ensembling':False,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'save_mlflow':True,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowDNN','TensorFlowLinearRegressor'],'whitelist_models':['Naive','AutoArima','Prophet','Arimax','TCNForecaster'],'compute_target':'httpTrigger-DS12v2','enable_dnn':True,'enable_code_generation':True,'experiment_exit_score':None,'experiment_timeout_minutes':1440,'featurization':'auto','hyperdrive_config':None,'grain_column_names':None,'is_timeseries':True,'iteration_timeout_minutes':1440,'max_concurrent_iterations':1,'metric_operation':'minimize','model_explainability':True,'n_cross_validations':'auto','name':'httpTrigger_prediction_experiment_1','path':'./sample_projects/httpTrigger_prediction_experiment_1','primary_metric':'normalized_root_mean_squared_error','region':'centralus','resource_group':'Genterist-Synapse-rg','subscription_id':'9242428f-6c6a-4667-8468-ce754a69b816','task_type':'regression','validation_size':None,'test_size':None,'vm_type':'STANDARD_DS12_V2','workspace_name':'geterist-test-ML','label_column_name':'Func_Numeric_ID','max_horizon':100,'country_or_region':None,'cv_step_size':200,'freq':None,'target_aggregation_function':None,'target_lags':None,'target_rolling_window_size':None,'time_column_name':'Func_index','enable_batch_run':True,'dataset_id':'5c0fa863-7b88-4f4f-b751-d88016dc0fd5'} # PLACEHOLDER
pipeline_spec = "{\"objects\":[{\"spec_class\":\"timeseries\",\"class_name\":\"Naive\",\"module\":\"automl.client.core.common.forecasting_models\",\"param_args\":[],\"param_kwargs\":{},\"prepared_kwargs\":{}}],\"pipeline_id\":\"__AutoML_Naive__\"}" # PLACEHOLDER
pipeline_id = "__AutoML_Naive__" # PLACEHOLDER
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"5c0fa863-7b88-4f4f-b751-d88016dc0fd5\"}}" # PLACEHOLDER
